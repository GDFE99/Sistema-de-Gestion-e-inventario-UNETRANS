<?php
    ...
    if($guardar_producto->rowCount()==1){
        $mensajeLog = "Se ha registrado un nuevo producto $nombre por el usuario $_SESSION[nombre]";
    escribirLog($mensajeLog, $_SESSION['id']);

    $detalle = "Producto registrado. Nombre: $nombre";
    registrarAuditoria(conexion(), $_SESSION['id'], $_SESSION['nombre'], 'producto', 'INSERT', $detalle);
        echo '
