        ...
        foreach ($datos as $rows) {
            $tabla .= '
                <tr class="has-text-centered" >
                    ...
                    <td>
                        <a href="#" onclick="confirmarEliminar(' . $rows['categoria_id'] . ')" class="button is-danger is-rounded is-small">Eliminar</a>
                    </td>
                </tr>
            ';
            $contador++;
...
<script>
    function confirmarEliminar(categoria_id) {
        if (confirm('¿Está seguro de eliminar esta categoría?')) {
            window.location.href = '<?php echo $url ?>' + '&category_id_del=' + categoria_id;
        }
    }
</script>
