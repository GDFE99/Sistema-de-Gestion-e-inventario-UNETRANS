...
<head>
    ...
    <style>
        ...
        .hero {
            position: relative; /* Posición relativa para que la superposición sea relativa a este contenedor */
            background-image: url("./img/UNETRANS.jpg"); /* Ruta relativa a la imagen local */
...
<body>
    ...
    .moving-text {
        ...
        font-size: 2.5rem; /* Cambia el tamaño de la fuente según tus preferencias */
        color: #fff; /* Cambia el color del texto según tus preferencias */
        animation: moveText 2s ease-in-out infinite alternate; /* Aplica el efecto de texto en movimiento */
    }
    ...
    @keyframes moveText {
        ...
        to {
            transform: translateY(10px); /* Cambia la cantidad de movimiento vertical según tus preferencias */
        }
    }
</style>
...
<div class="feature-description">Administra los préstamos de productos a los diferentes profesores de manera ágil y organizada.</div>
                ...
                <div class="column is-4">
                    <div class="feature-card">
                        ...
                        <div class="feature-description">Accede fácilmente a la descarga y consulta de los PDFs de los productos, prestamos y auditoria en el sistema de inventario.</div>
                    </div>
                </div>
            </div>
        </div>
